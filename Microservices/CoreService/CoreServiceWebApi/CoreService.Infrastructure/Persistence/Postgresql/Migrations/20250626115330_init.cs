        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_UserProfiles_ProfileUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Answers_UserProfiles_ProfileUserId",
                        column: x => x.ProfileUserId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryQuestions", x => new { x.QuestionId, x.CategoryId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentQuestions_UserProfiles_ProfileUserId",
                        column: x => x.ProfileUserId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    QuestionId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsGoodQuestion = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionRatings_UserProfiles_ProfileUserId",
                        column: x => x.ProfileUserId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnswerRatings_UserProfiles_ProfileUserId",
                        column: x => x.ProfileUserId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentAnswers_UserProfiles_ProfileUserId",
                        column: x => x.ProfileUserId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerRatings_AnswerId",
                table: "AnswerRatings",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_AnswerRatings_ProfileUserId",
                table: "AnswerRatings",
                column: "ProfileUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Answers_ProfileUserId",
                table: "Answers",
                column: "ProfileUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentAnswers_ProfileUserId",
                table: "CommentAnswers",
                column: "ProfileUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentQuestions_ProfileUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionRatings_ProfileUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_ProfileUserId",
                table: "Questions",
                column: "ProfileUserId");
