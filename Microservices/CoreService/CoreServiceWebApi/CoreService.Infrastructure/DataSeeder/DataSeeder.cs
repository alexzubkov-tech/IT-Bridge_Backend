                ...
                if (!dbContext.Companies.Any())
                {
                    await dbContext.Companies.AddRangeAsync(
                        new Company
                        {
                            ...
                            FoundationDate = new DateTime(2015, 1, 1).ToUniversalTime(),
                            EmployeeCount = 200,
                        ...
                        new Company
                        {
                            ...
                            FoundationDate = new DateTime(2018, 5, 15).ToUniversalTime(),
                            EmployeeCount = 80,
                        ...
                        new Company
                        {
                            ...
                            FoundationDate = new DateTime(2017, 3, 10).ToUniversalTime(),
                            EmployeeCount = 120,
                        ...
                        new Company
                        {
                            ...
                            TaxID = "4567890123",
                            Address = "ул. Арт, д. 3",
                            FoundationDate = new DateTime(2016, 7, 20).ToUniversalTime(),
                            EmployeeCount = 40,
                        ...
                        new Company
                        {
                            ...
                            FoundationDate = new DateTime(2020, 11, 5).ToUniversalTime(),
                            EmployeeCount = 300,
                            Industry = Industry.IT,
